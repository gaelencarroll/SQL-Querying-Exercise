...
SELECT * FROM analytics WHERE rating != null AND min_installs < 50 ORDER BY rating DESC
...
SELECT app_name,reviews,min_installs,proportion FROM analytics WHERE min_installs > 100000 ORDER BY reviews/min_installs AS proportion DESC LIMIT 1